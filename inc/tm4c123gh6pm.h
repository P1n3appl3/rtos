...
//*****************************************************************************
#define UDMA_SRCENDP                                                           \
    0x00000000 // DMA Channel Source Address End
               // Pointer
#define UDMA_DSTENDP                                                           \
    0x00000004                // DMA Channel Destination Address
                              // End Pointer
...
#define SSI_IM_RTIM                                                            \
    0x00000002 // SSI Receive Time-Out Interrupt
               // Mask
#define SSI_IM_RORIM                                                           \
    0x00000001 // SSI Receive Overrun Interrupt
               // Mask
...
//
//*****************************************************************************
#define SSI_RIS_TXRIS                                                          \
    0x00000008 // SSI Transmit FIFO Raw Interrupt
               // Status
#define SSI_RIS_RXRIS                                                          \
    0x00000004 // SSI Receive FIFO Raw Interrupt
               // Status
#define SSI_RIS_RTRIS                                                          \
    0x00000002 // SSI Receive Time-Out Raw
               // Interrupt Status
#define SSI_RIS_RORRIS                                                         \
    0x00000001 // SSI Receive Overrun Raw
               // Interrupt Status
...
//
//*****************************************************************************
#define SSI_MIS_TXMIS                                                          \
    0x00000008 // SSI Transmit FIFO Masked
               // Interrupt Status
#define SSI_MIS_RXMIS                                                          \
    0x00000004 // SSI Receive FIFO Masked
               // Interrupt Status
#define SSI_MIS_RTMIS                                                          \
    0x00000002 // SSI Receive Time-Out Masked
               // Interrupt Status
#define SSI_MIS_RORMIS                                                         \
    0x00000001 // SSI Receive Overrun Masked
               // Interrupt Status
...
#define SSI_CC_CS_SYSPLL                                                       \
    0x00000000                     // System clock (based on clock
...
#define UART_IFLS_RX_M                                                         \
    0x00000038                     // UART Receive Interrupt FIFO
                                   // Level Select
...
#define UART_IFLS_TX_M                                                         \
    0x00000007                     // UART Transmit Interrupt FIFO
                                   // Level Select
...
#define UART_IM_OEIM                                                           \
    0x00000400                  // UART Overrun Error Interrupt
                                // Mask
#define UART_IM_BEIM 0x00000200 // UART Break Error Interrupt Mask
#define UART_IM_PEIM 0x00000100 // UART Parity Error Interrupt Mask
#define UART_IM_FEIM                                                           \
    0x00000080 // UART Framing Error Interrupt
               // Mask
#define UART_IM_RTIM                                                           \
...
#define UART_IM_CTSMIM                                                         \
    0x00000002 // UART Clear to Send Modem
               // Interrupt Mask
...
#define UART_RIS_OERIS                                                         \
    0x00000400 // UART Overrun Error Raw Interrupt
               // Status
#define UART_RIS_BERIS                                                         \
    0x00000200 // UART Break Error Raw Interrupt
               // Status
#define UART_RIS_PERIS                                                         \
    0x00000100 // UART Parity Error Raw Interrupt
               // Status
#define UART_RIS_FERIS                                                         \
    0x00000080 // UART Framing Error Raw Interrupt
               // Status
...
#define UART_RIS_RXRIS                                                         \
    0x00000010 // UART Receive Raw Interrupt
               // Status
#define UART_RIS_CTSRIS                                                        \
    0x00000002 // UART Clear to Send Modem Raw
               // Interrupt Status
...
//
//*****************************************************************************
#define UART_MIS_9BITMIS                                                       \
    0x00001000 // 9-Bit Mode Masked Interrupt
               // Status
#define UART_MIS_OEMIS                                                         \
    0x00000400 // UART Overrun Error Masked
               // Interrupt Status
#define UART_MIS_BEMIS                                                         \
    0x00000200 // UART Break Error Masked
               // Interrupt Status
#define UART_MIS_PEMIS                                                         \
    0x00000100 // UART Parity Error Masked
               // Interrupt Status
#define UART_MIS_FEMIS                                                         \
    0x00000080 // UART Framing Error Masked
               // Interrupt Status
#define UART_MIS_RTMIS                                                         \
    0x00000040 // UART Receive Time-Out Masked
               // Interrupt Status
#define UART_MIS_TXMIS                                                         \
    0x00000020 // UART Transmit Masked Interrupt
               // Status
#define UART_MIS_RXMIS                                                         \
    0x00000010 // UART Receive Masked Interrupt
               // Status
#define UART_MIS_CTSMIS                                                        \
    0x00000002 // UART Clear to Send Modem Masked
               // Interrupt Status
...
//
//*****************************************************************************
#define PWM_0_INTEN_TRCMPBD                                                    \
    0x00002000                         // Trigger for Counter=PWMnCMPB
                                       // Down
#define PWM_0_INTEN_TRCMPBU 0x00001000 // Trigger for Counter=PWMnCMPB Up
#define PWM_0_INTEN_TRCMPAD                                                    \
    0x00000800                           // Trigger for Counter=PWMnCMPA
                                         // Down
...
#define PWM_0_INTEN_INTCMPBD                                                   \
    0x00000020 // Interrupt for Counter=PWMnCMPB
               // Down
#define PWM_0_INTEN_INTCMPBU                                                   \
    0x00000010 // Interrupt for Counter=PWMnCMPB
               // Up
#define PWM_0_INTEN_INTCMPAD                                                   \
    0x00000008 // Interrupt for Counter=PWMnCMPA
               // Down
#define PWM_0_INTEN_INTCMPAU                                                   \
    0x00000004                            // Interrupt for Counter=PWMnCMPA
                                          // Up
...
//
//*****************************************************************************
#define PWM_0_RIS_INTCMPBD                                                     \
    0x00000020                        // Comparator B Down Interrupt
                                      // Status
#define PWM_0_RIS_INTCMPBU 0x00000010 // Comparator B Up Interrupt Status
#define PWM_0_RIS_INTCMPAD                                                     \
    0x00000008                          // Comparator A Down Interrupt
                                        // Status
...
#define PWM_0_GENA_ACTCMPBD_NONE 0x00000000 // Do nothing
#define PWM_0_GENA_ACTCMPBD_INV 0x00000400  // Invert pwmA
#define PWM_0_GENA_ACTCMPBD_ZERO 0x00000800 // Drive pwmA Low
...
#define PWM_0_GENA_ACTCMPBU_NONE 0x00000000 // Do nothing
#define PWM_0_GENA_ACTCMPBU_INV 0x00000100  // Invert pwmA
#define PWM_0_GENA_ACTCMPBU_ZERO 0x00000200 // Drive pwmA Low
...
#define PWM_0_GENA_ACTCMPAD_NONE 0x00000000 // Do nothing
#define PWM_0_GENA_ACTCMPAD_INV 0x00000040  // Invert pwmA
#define PWM_0_GENA_ACTCMPAD_ZERO 0x00000080 // Drive pwmA Low
...
#define PWM_0_GENA_ACTCMPAU_NONE 0x00000000 // Do nothing
#define PWM_0_GENA_ACTCMPAU_INV 0x00000010  // Invert pwmA
#define PWM_0_GENA_ACTCMPAU_ZERO 0x00000020 // Drive pwmA Low
...
#define PWM_0_GENB_ACTCMPBD_NONE 0x00000000 // Do nothing
#define PWM_0_GENB_ACTCMPBD_INV 0x00000400  // Invert pwmB
#define PWM_0_GENB_ACTCMPBD_ZERO 0x00000800 // Drive pwmB Low
...
#define PWM_0_GENB_ACTCMPBU_NONE 0x00000000 // Do nothing
#define PWM_0_GENB_ACTCMPBU_INV 0x00000100  // Invert pwmB
#define PWM_0_GENB_ACTCMPBU_ZERO 0x00000200 // Drive pwmB Low
...
#define PWM_0_GENB_ACTCMPAD_NONE 0x00000000 // Do nothing
#define PWM_0_GENB_ACTCMPAD_INV 0x00000040  // Invert pwmB
#define PWM_0_GENB_ACTCMPAD_ZERO 0x00000080 // Drive pwmB Low
...
#define PWM_0_GENB_ACTCMPAU_NONE 0x00000000 // Do nothing
#define PWM_0_GENB_ACTCMPAU_INV 0x00000010  // Invert pwmB
#define PWM_0_GENB_ACTCMPAU_ZERO 0x00000020 // Drive pwmB Low
...
#define PWM_1_INTEN_INTCMPBD                                                   \
    0x00000020 // Interrupt for Counter=PWMnCMPB
               // Down
#define PWM_1_INTEN_INTCMPBU                                                   \
    0x00000010 // Interrupt for Counter=PWMnCMPB
               // Up
#define PWM_1_INTEN_INTCMPAD                                                   \
    0x00000008 // Interrupt for Counter=PWMnCMPA
               // Down
#define PWM_1_INTEN_INTCMPAU                                                   \
    0x00000004                            // Interrupt for Counter=PWMnCMPA
                                          // Up
...
#define PWM_1_GENA_ACTCMPBD_NONE 0x00000000 // Do nothing
#define PWM_1_GENA_ACTCMPBD_INV 0x00000400  // Invert pwmA
#define PWM_1_GENA_ACTCMPBD_ZERO 0x00000800 // Drive pwmA Low
...
#define PWM_1_GENA_ACTCMPBU_NONE 0x00000000 // Do nothing
#define PWM_1_GENA_ACTCMPBU_INV 0x00000100  // Invert pwmA
#define PWM_1_GENA_ACTCMPBU_ZERO 0x00000200 // Drive pwmA Low
...
#define PWM_1_GENA_ACTCMPAD_NONE 0x00000000 // Do nothing
#define PWM_1_GENA_ACTCMPAD_INV 0x00000040  // Invert pwmA
#define PWM_1_GENA_ACTCMPAD_ZERO 0x00000080 // Drive pwmA Low
...
#define PWM_1_GENA_ACTCMPAU_NONE 0x00000000 // Do nothing
#define PWM_1_GENA_ACTCMPAU_INV 0x00000010  // Invert pwmA
#define PWM_1_GENA_ACTCMPAU_ZERO 0x00000020 // Drive pwmA Low
...
#define PWM_1_GENB_ACTCMPBD_NONE 0x00000000 // Do nothing
#define PWM_1_GENB_ACTCMPBD_INV 0x00000400  // Invert pwmB
#define PWM_1_GENB_ACTCMPBD_ZERO 0x00000800 // Drive pwmB Low
...
#define PWM_1_GENB_ACTCMPBU_NONE 0x00000000 // Do nothing
#define PWM_1_GENB_ACTCMPBU_INV 0x00000100  // Invert pwmB
#define PWM_1_GENB_ACTCMPBU_ZERO 0x00000200 // Drive pwmB Low
...
#define PWM_1_GENB_ACTCMPAD_NONE 0x00000000 // Do nothing
#define PWM_1_GENB_ACTCMPAD_INV 0x00000040  // Invert pwmB
#define PWM_1_GENB_ACTCMPAD_ZERO 0x00000080 // Drive pwmB Low
...
#define PWM_1_GENB_ACTCMPAU_NONE 0x00000000 // Do nothing
#define PWM_1_GENB_ACTCMPAU_INV 0x00000010  // Invert pwmB
#define PWM_1_GENB_ACTCMPAU_ZERO 0x00000020 // Drive pwmB Low
...
//
//*****************************************************************************
#define PWM_1_DBRISE_RISEDELAY_M 0x00000FFF // Dead-Band Rise Delay
...
//
//*****************************************************************************
#define PWM_1_DBFALL_FALLDELAY_M 0x00000FFF // Dead-Band Fall Delay
...
#define PWM_2_INTEN_INTCMPBD                                                   \
    0x00000020 // Interrupt for Counter=PWMnCMPB
               // Down
#define PWM_2_INTEN_INTCMPBU                                                   \
    0x00000010 // Interrupt for Counter=PWMnCMPB
               // Up
#define PWM_2_INTEN_INTCMPAD                                                   \
    0x00000008 // Interrupt for Counter=PWMnCMPA
               // Down
#define PWM_2_INTEN_INTCMPAU                                                   \
    0x00000004                            // Interrupt for Counter=PWMnCMPA
                                          // Up
...
#define PWM_2_GENA_ACTCMPBD_NONE 0x00000000 // Do nothing
#define PWM_2_GENA_ACTCMPBD_INV 0x00000400  // Invert pwmA
#define PWM_2_GENA_ACTCMPBD_ZERO 0x00000800 // Drive pwmA Low
...
#define PWM_2_GENA_ACTCMPBU_NONE 0x00000000 // Do nothing
#define PWM_2_GENA_ACTCMPBU_INV 0x00000100  // Invert pwmA
#define PWM_2_GENA_ACTCMPBU_ZERO 0x00000200 // Drive pwmA Low
...
#define PWM_2_GENA_ACTCMPAD_NONE 0x00000000 // Do nothing
#define PWM_2_GENA_ACTCMPAD_INV 0x00000040  // Invert pwmA
#define PWM_2_GENA_ACTCMPAD_ZERO 0x00000080 // Drive pwmA Low
...
#define PWM_2_GENA_ACTCMPAU_NONE 0x00000000 // Do nothing
#define PWM_2_GENA_ACTCMPAU_INV 0x00000010  // Invert pwmA
#define PWM_2_GENA_ACTCMPAU_ZERO 0x00000020 // Drive pwmA Low
...
#define PWM_2_GENB_ACTCMPBD_NONE 0x00000000 // Do nothing
#define PWM_2_GENB_ACTCMPBD_INV 0x00000400  // Invert pwmB
#define PWM_2_GENB_ACTCMPBD_ZERO 0x00000800 // Drive pwmB Low
...
#define PWM_2_GENB_ACTCMPBU_NONE 0x00000000 // Do nothing
#define PWM_2_GENB_ACTCMPBU_INV 0x00000100  // Invert pwmB
#define PWM_2_GENB_ACTCMPBU_ZERO 0x00000200 // Drive pwmB Low
...
#define PWM_2_GENB_ACTCMPAD_NONE 0x00000000 // Do nothing
#define PWM_2_GENB_ACTCMPAD_INV 0x00000040  // Invert pwmB
#define PWM_2_GENB_ACTCMPAD_ZERO 0x00000080 // Drive pwmB Low
...
#define PWM_2_GENB_ACTCMPAU_NONE 0x00000000 // Do nothing
#define PWM_2_GENB_ACTCMPAU_INV 0x00000010  // Invert pwmB
#define PWM_2_GENB_ACTCMPAU_ZERO 0x00000020 // Drive pwmB Low
...
//
//*****************************************************************************
#define PWM_2_DBRISE_RISEDELAY_M 0x00000FFF // Dead-Band Rise Delay
...
//
//*****************************************************************************
#define PWM_2_DBFALL_FALLDELAY_M 0x00000FFF // Dead-Band Fall Delay
...
#define PWM_3_INTEN_INTCMPBD                                                   \
    0x00000020 // Interrupt for Counter=PWMnCMPB
               // Down
#define PWM_3_INTEN_INTCMPBU                                                   \
    0x00000010 // Interrupt for Counter=PWMnCMPB
               // Up
#define PWM_3_INTEN_INTCMPAD                                                   \
    0x00000008 // Interrupt for Counter=PWMnCMPA
               // Down
#define PWM_3_INTEN_INTCMPAU                                                   \
    0x00000004                            // Interrupt for Counter=PWMnCMPA
                                          // Up
...
#define PWM_3_GENA_ACTCMPBD_NONE 0x00000000 // Do nothing
#define PWM_3_GENA_ACTCMPBD_INV 0x00000400  // Invert pwmA
#define PWM_3_GENA_ACTCMPBD_ZERO 0x00000800 // Drive pwmA Low
...
#define PWM_3_GENA_ACTCMPBU_NONE 0x00000000 // Do nothing
#define PWM_3_GENA_ACTCMPBU_INV 0x00000100  // Invert pwmA
#define PWM_3_GENA_ACTCMPBU_ZERO 0x00000200 // Drive pwmA Low
...
#define PWM_3_GENA_ACTCMPAD_NONE 0x00000000 // Do nothing
#define PWM_3_GENA_ACTCMPAD_INV 0x00000040  // Invert pwmA
#define PWM_3_GENA_ACTCMPAD_ZERO 0x00000080 // Drive pwmA Low
...
#define PWM_3_GENA_ACTCMPAU_NONE 0x00000000 // Do nothing
#define PWM_3_GENA_ACTCMPAU_INV 0x00000010  // Invert pwmA
#define PWM_3_GENA_ACTCMPAU_ZERO 0x00000020 // Drive pwmA Low
...
#define PWM_3_GENB_ACTCMPBD_NONE 0x00000000 // Do nothing
#define PWM_3_GENB_ACTCMPBD_INV 0x00000400  // Invert pwmB
#define PWM_3_GENB_ACTCMPBD_ZERO 0x00000800 // Drive pwmB Low
...
#define PWM_3_GENB_ACTCMPBU_NONE 0x00000000 // Do nothing
#define PWM_3_GENB_ACTCMPBU_INV 0x00000100  // Invert pwmB
#define PWM_3_GENB_ACTCMPBU_ZERO 0x00000200 // Drive pwmB Low
...
#define PWM_3_GENB_ACTCMPAD_NONE 0x00000000 // Do nothing
#define PWM_3_GENB_ACTCMPAD_INV 0x00000040  // Invert pwmB
#define PWM_3_GENB_ACTCMPAD_ZERO 0x00000080 // Drive pwmB Low
...
#define PWM_3_GENB_ACTCMPAU_NONE 0x00000000 // Do nothing
#define PWM_3_GENB_ACTCMPAU_INV 0x00000010  // Invert pwmB
#define PWM_3_GENB_ACTCMPAU_ZERO 0x00000020 // Drive pwmB Low
...
//
//*****************************************************************************
#define PWM_3_DBRISE_RISEDELAY_M 0x00000FFF // Dead-Band Rise Delay
...
//
//*****************************************************************************
#define PWM_3_DBFALL_FALLDELAY_M 0x00000FFF // Dead-Band Fall Delay
...
//*****************************************************************************
#define QEI_POS_M                                                              \
    0xFFFFFFFF // Current Position Integrator
               // Value
#define QEI_POS_S 0
...
#define QEI_INTEN_DIR                                                          \
    0x00000004                     // Direction Change Interrupt
                                   // Enable
...
#define TIMER_CFG_32_BIT_TIMER                                                 \
    0x00000000 // For a 16/32-bit timer, this
               // value selects the 32-bit timer
               // configuration
#define TIMER_CFG_32_BIT_RTC                                                   \
    0x00000001 // For a 16/32-bit timer, this
               // value selects the 32-bit
               // real-time clock (RTC) counter
               // configuration
#define TIMER_CFG_16_BIT                                                       \
    0x00000004 // For a 16/32-bit timer, this
...
//
//*****************************************************************************
#define TIMER_TAMR_TAPLO                                                       \
    0x00000800 // GPTM Timer A PWM Legacy
               // Operation
#define TIMER_TAMR_TAMRSU                                                      \
    0x00000400 // GPTM Timer A Match Register
               // Update
#define TIMER_TAMR_TAPWMIE                                                     \
    0x00000200                        // GPTM Timer A PWM Interrupt
                                      // Enable
#define TIMER_TAMR_TAILD 0x00000100   // GPTM Timer A Interval Load Write
#define TIMER_TAMR_TASNAPS 0x00000080 // GPTM Timer A Snap-Shot Mode
#define TIMER_TAMR_TAWOT 0x00000040   // GPTM Timer A Wait-on-Trigger
#define TIMER_TAMR_TAMIE                                                       \
    0x00000020                       // GPTM Timer A Match Interrupt
                                     // Enable
#define TIMER_TAMR_TACDIR 0x00000010 // GPTM Timer A Count Direction
#define TIMER_TAMR_TAAMS                                                       \
    0x00000008                            // GPTM Timer A Alternate Mode
                                          // Select
...
//
//*****************************************************************************
#define TIMER_TBMR_TBPLO                                                       \
    0x00000800 // GPTM Timer B PWM Legacy
               // Operation
#define TIMER_TBMR_TBMRSU                                                      \
    0x00000400 // GPTM Timer B Match Register
               // Update
#define TIMER_TBMR_TBPWMIE                                                     \
    0x00000200                        // GPTM Timer B PWM Interrupt
                                      // Enable
#define TIMER_TBMR_TBILD 0x00000100   // GPTM Timer B Interval Load Write
#define TIMER_TBMR_TBSNAPS 0x00000080 // GPTM Timer B Snap-Shot Mode
#define TIMER_TBMR_TBWOT 0x00000040   // GPTM Timer B Wait-on-Trigger
#define TIMER_TBMR_TBMIE                                                       \
    0x00000020                       // GPTM Timer B Match Interrupt
                                     // Enable
#define TIMER_TBMR_TBCDIR 0x00000010 // GPTM Timer B Count Direction
#define TIMER_TBMR_TBAMS                                                       \
    0x00000008                            // GPTM Timer B Alternate Mode
                                          // Select
...
#define TIMER_CTL_TBOTE                                                        \
    0x00002000                            // GPTM Timer B Output Trigger
                                          // Enable
...
#define TIMER_CTL_TAOTE                                                        \
    0x00000020                            // GPTM Timer A Output Trigger
                                          // Enable
...
//
//*****************************************************************************
#define TIMER_SYNC_SYNCWT5_M                                                   \
    0x00C00000 // Synchronize GPTM 32/64-Bit Timer
               // 5
#define TIMER_SYNC_SYNCWT5_NONE                                                \
    0x00000000 // GPTM 32/64-Bit Timer 5 is not
               // affected
#define TIMER_SYNC_SYNCWT5_TA                                                  \
    0x00400000 // A timeout event for Timer A of
               // GPTM 32/64-Bit Timer 5 is
               // triggered
#define TIMER_SYNC_SYNCWT5_TB                                                  \
    0x00800000 // A timeout event for Timer B of
               // GPTM 32/64-Bit Timer 5 is
               // triggered
#define TIMER_SYNC_SYNCWT5_TATB                                                \
    0x00C00000 // A timeout event for both Timer A
               // and Timer B of GPTM 32/64-Bit
               // Timer 5 is triggered
#define TIMER_SYNC_SYNCWT4_M                                                   \
    0x00300000 // Synchronize GPTM 32/64-Bit Timer
               // 4
#define TIMER_SYNC_SYNCWT4_NONE                                                \
    0x00000000 // GPTM 32/64-Bit Timer 4 is not
               // affected
#define TIMER_SYNC_SYNCWT4_TA                                                  \
    0x00100000 // A timeout event for Timer A of
               // GPTM 32/64-Bit Timer 4 is
               // triggered
#define TIMER_SYNC_SYNCWT4_TB                                                  \
    0x00200000 // A timeout event for Timer B of
               // GPTM 32/64-Bit Timer 4 is
               // triggered
#define TIMER_SYNC_SYNCWT4_TATB                                                \
    0x00300000 // A timeout event for both Timer A
               // and Timer B of GPTM 32/64-Bit
               // Timer 4 is triggered
#define TIMER_SYNC_SYNCWT3_M                                                   \
    0x000C0000 // Synchronize GPTM 32/64-Bit Timer
               // 3
#define TIMER_SYNC_SYNCWT3_NONE                                                \
    0x00000000 // GPTM 32/64-Bit Timer 3 is not
               // affected
#define TIMER_SYNC_SYNCWT3_TA                                                  \
    0x00040000 // A timeout event for Timer A of
               // GPTM 32/64-Bit Timer 3 is
               // triggered
#define TIMER_SYNC_SYNCWT3_TB                                                  \
    0x00080000 // A timeout event for Timer B of
               // GPTM 32/64-Bit Timer 3 is
               // triggered
#define TIMER_SYNC_SYNCWT3_TATB                                                \
    0x000C0000 // A timeout event for both Timer A
               // and Timer B of GPTM 32/64-Bit
               // Timer 3 is triggered
#define TIMER_SYNC_SYNCWT2_M                                                   \
    0x00030000 // Synchronize GPTM 32/64-Bit Timer
               // 2
#define TIMER_SYNC_SYNCWT2_NONE                                                \
    0x00000000 // GPTM 32/64-Bit Timer 2 is not
               // affected
#define TIMER_SYNC_SYNCWT2_TA                                                  \
    0x00010000 // A timeout event for Timer A of
               // GPTM 32/64-Bit Timer 2 is
               // triggered
#define TIMER_SYNC_SYNCWT2_TB                                                  \
    0x00020000 // A timeout event for Timer B of
               // GPTM 32/64-Bit Timer 2 is
               // triggered
#define TIMER_SYNC_SYNCWT2_TATB                                                \
    0x00030000 // A timeout event for both Timer A
               // and Timer B of GPTM 32/64-Bit
               // Timer 2 is triggered
#define TIMER_SYNC_SYNCWT1_M                                                   \
    0x0000C000 // Synchronize GPTM 32/64-Bit Timer
               // 1
#define TIMER_SYNC_SYNCWT1_NONE                                                \
    0x00000000 // GPTM 32/64-Bit Timer 1 is not
               // affected
#define TIMER_SYNC_SYNCWT1_TA                                                  \
    0x00004000 // A timeout event for Timer A of
               // GPTM 32/64-Bit Timer 1 is
               // triggered
#define TIMER_SYNC_SYNCWT1_TB                                                  \
    0x00008000 // A timeout event for Timer B of
               // GPTM 32/64-Bit Timer 1 is
               // triggered
#define TIMER_SYNC_SYNCWT1_TATB                                                \
    0x0000C000 // A timeout event for both Timer A
               // and Timer B of GPTM 32/64-Bit
               // Timer 1 is triggered
#define TIMER_SYNC_SYNCWT0_M                                                   \
    0x00003000 // Synchronize GPTM 32/64-Bit Timer
               // 0
#define TIMER_SYNC_SYNCWT0_NONE                                                \
    0x00000000 // GPTM 32/64-Bit Timer 0 is not
               // affected
#define TIMER_SYNC_SYNCWT0_TA                                                  \
    0x00001000 // A timeout event for Timer A of
               // GPTM 32/64-Bit Timer 0 is
               // triggered
#define TIMER_SYNC_SYNCWT0_TB                                                  \
    0x00002000 // A timeout event for Timer B of
               // GPTM 32/64-Bit Timer 0 is
               // triggered
#define TIMER_SYNC_SYNCWT0_TATB                                                \
    0x00003000                            // A timeout event for both Timer A
                                          // and Timer B of GPTM 32/64-Bit
...
#define TIMER_SYNC_SYNCT5_TA                                                   \
    0x00000400 // A timeout event for Timer A of
               // GPTM5 is triggered
#define TIMER_SYNC_SYNCT5_TB                                                   \
    0x00000800 // A timeout event for Timer B of
               // GPTM5 is triggered
#define TIMER_SYNC_SYNCT5_TATB                                                 \
    0x00000C00                            // A timeout event for both Timer A
...
#define TIMER_SYNC_SYNCT4_TA                                                   \
    0x00000100 // A timeout event for Timer A of
               // GPTM4 is triggered
#define TIMER_SYNC_SYNCT4_TB                                                   \
    0x00000200 // A timeout event for Timer B of
               // GPTM4 is triggered
#define TIMER_SYNC_SYNCT4_TATB                                                 \
    0x00000300                            // A timeout event for both Timer A
...
#define TIMER_SYNC_SYNCT3_TA                                                   \
    0x00000040 // A timeout event for Timer A of
               // GPTM3 is triggered
#define TIMER_SYNC_SYNCT3_TB                                                   \
    0x00000080 // A timeout event for Timer B of
               // GPTM3 is triggered
#define TIMER_SYNC_SYNCT3_TATB                                                 \
    0x000000C0                            // A timeout event for both Timer A
...
#define TIMER_SYNC_SYNCT2_TA                                                   \
    0x00000010 // A timeout event for Timer A of
               // GPTM2 is triggered
#define TIMER_SYNC_SYNCT2_TB                                                   \
    0x00000020 // A timeout event for Timer B of
               // GPTM2 is triggered
#define TIMER_SYNC_SYNCT2_TATB                                                 \
    0x00000030                            // A timeout event for both Timer A
...
#define TIMER_SYNC_SYNCT1_TA                                                   \
    0x00000004 // A timeout event for Timer A of
               // GPTM1 is triggered
#define TIMER_SYNC_SYNCT1_TB                                                   \
    0x00000008 // A timeout event for Timer B of
               // GPTM1 is triggered
#define TIMER_SYNC_SYNCT1_TATB                                                 \
    0x0000000C                            // A timeout event for both Timer A
...
#define TIMER_SYNC_SYNCT0_TA                                                   \
    0x00000001 // A timeout event for Timer A of
               // GPTM0 is triggered
#define TIMER_SYNC_SYNCT0_TB                                                   \
    0x00000002 // A timeout event for Timer B of
               // GPTM0 is triggered
#define TIMER_SYNC_SYNCT0_TATB                                                 \
    0x00000003 // A timeout event for both Timer A
...
//
//*****************************************************************************
#define TIMER_IMR_WUEIM                                                        \
    0x00010000 // 32/64-Bit Wide GPTM Write Update
               // Error Interrupt Mask
#define TIMER_IMR_TBMIM                                                        \
    0x00000800 // GPTM Timer B Match Interrupt
               // Mask
#define TIMER_IMR_CBEIM                                                        \
    0x00000400 // GPTM Timer B Capture Mode Event
               // Interrupt Mask
#define TIMER_IMR_CBMIM                                                        \
    0x00000200 // GPTM Timer B Capture Mode Match
               // Interrupt Mask
#define TIMER_IMR_TBTOIM                                                       \
    0x00000100 // GPTM Timer B Time-Out Interrupt
               // Mask
#define TIMER_IMR_TAMIM                                                        \
    0x00000010                     // GPTM Timer A Match Interrupt
                                   // Mask
#define TIMER_IMR_RTCIM 0x00000008 // GPTM RTC Interrupt Mask
#define TIMER_IMR_CAEIM                                                        \
    0x00000004 // GPTM Timer A Capture Mode Event
               // Interrupt Mask
#define TIMER_IMR_CAMIM                                                        \
    0x00000002 // GPTM Timer A Capture Mode Match
               // Interrupt Mask
#define TIMER_IMR_TATOIM                                                       \
    0x00000001 // GPTM Timer A Time-Out Interrupt
               // Mask
...
#define TIMER_RIS_CBERIS                                                       \
    0x00000400 // GPTM Timer B Capture Mode Event
               // Raw Interrupt
#define TIMER_RIS_CBMRIS                                                       \
    0x00000200 // GPTM Timer B Capture Mode Match
               // Raw Interrupt
#define TIMER_RIS_TBTORIS                                                      \
    0x00000100                      // GPTM Timer B Time-Out Raw
                                    // Interrupt
#define TIMER_RIS_TAMRIS 0x00000010 // GPTM Timer A Match Raw Interrupt
#define TIMER_RIS_RTCRIS 0x00000008 // GPTM RTC Raw Interrupt
#define TIMER_RIS_CAERIS                                                       \
    0x00000004 // GPTM Timer A Capture Mode Event
               // Raw Interrupt
#define TIMER_RIS_CAMRIS                                                       \
    0x00000002 // GPTM Timer A Capture Mode Match
               // Raw Interrupt
#define TIMER_RIS_TATORIS                                                      \
    0x00000001 // GPTM Timer A Time-Out Raw
               // Interrupt
...
//
//*****************************************************************************
#define TIMER_MIS_WUEMIS                                                       \
    0x00010000 // 32/64-Bit Wide GPTM Write Update
               // Error Masked Interrupt Status
#define TIMER_MIS_TBMMIS                                                       \
    0x00000800 // GPTM Timer B Match Masked
               // Interrupt
#define TIMER_MIS_CBEMIS                                                       \
    0x00000400 // GPTM Timer B Capture Mode Event
               // Masked Interrupt
#define TIMER_MIS_CBMMIS                                                       \
    0x00000200 // GPTM Timer B Capture Mode Match
               // Masked Interrupt
#define TIMER_MIS_TBTOMIS                                                      \
    0x00000100 // GPTM Timer B Time-Out Masked
               // Interrupt
#define TIMER_MIS_TAMMIS                                                       \
    0x00000010                      // GPTM Timer A Match Masked
                                    // Interrupt
#define TIMER_MIS_RTCMIS 0x00000008 // GPTM RTC Masked Interrupt
#define TIMER_MIS_CAEMIS                                                       \
    0x00000004 // GPTM Timer A Capture Mode Event
               // Masked Interrupt
#define TIMER_MIS_CAMMIS                                                       \
    0x00000002 // GPTM Timer A Capture Mode Match
               // Masked Interrupt
#define TIMER_MIS_TATOMIS                                                      \
    0x00000001 // GPTM Timer A Time-Out Masked
               // Interrupt
...
//
//*****************************************************************************
#define TIMER_ICR_WUECINT                                                      \
    0x00010000 // 32/64-Bit Wide GPTM Write Update
               // Error Interrupt Clear
#define TIMER_ICR_TBMCINT                                                      \
    0x00000800 // GPTM Timer B Match Interrupt
               // Clear
#define TIMER_ICR_CBECINT                                                      \
    0x00000400 // GPTM Timer B Capture Mode Event
               // Interrupt Clear
#define TIMER_ICR_CBMCINT                                                      \
    0x00000200 // GPTM Timer B Capture Mode Match
               // Interrupt Clear
#define TIMER_ICR_TBTOCINT                                                     \
    0x00000100 // GPTM Timer B Time-Out Interrupt
               // Clear
#define TIMER_ICR_TAMCINT                                                      \
    0x00000010                       // GPTM Timer A Match Interrupt
                                     // Clear
#define TIMER_ICR_RTCCINT 0x00000008 // GPTM RTC Interrupt Clear
#define TIMER_ICR_CAECINT                                                      \
    0x00000004 // GPTM Timer A Capture Mode Event
               // Interrupt Clear
#define TIMER_ICR_CAMCINT                                                      \
    0x00000002 // GPTM Timer A Capture Mode Match
               // Interrupt Clear
...
//
//*****************************************************************************
#define TIMER_TAILR_M                                                          \
    0xFFFFFFFF // GPTM Timer A Interval Load
               // Register
...
//
//*****************************************************************************
#define TIMER_TBILR_M                                                          \
    0xFFFFFFFF // GPTM Timer B Interval Load
               // Register
...
//
//*****************************************************************************
#define TIMER_TAPMR_TAPSMRH_M                                                  \
    0x0000FF00                          // GPTM Timer A Prescale Match High
                                        // Byte
...
//
//*****************************************************************************
#define TIMER_TBPMR_TBPSMRH_M                                                  \
    0x0000FF00                          // GPTM Timer B Prescale Match High
                                        // Byte
...
#define TIMER_PP_SIZE_16                                                       \
    0x00000000 // Timer A and Timer B counters are
               // 16 bits each with an 8-bit
               // prescale counter
#define TIMER_PP_SIZE_32                                                       \
    0x00000001 // Timer A and Timer B counters are
...
#define ADC_RIS_INRDC                                                          \
    0x00010000                  // Digital Comparator Raw Interrupt
                                // Status
...
//
//*****************************************************************************
#define ADC_TSSEL_PS3_M                                                        \
    0x30000000 // Generator 3 PWM Module Trigger
               // Select
#define ADC_TSSEL_PS3_0                                                        \
    0x00000000 // Use Generator 3 (and its
               // trigger) in PWM module 0
#define ADC_TSSEL_PS3_1                                                        \
    0x10000000 // Use Generator 3 (and its
               // trigger) in PWM module 1
#define ADC_TSSEL_PS2_M                                                        \
    0x00300000 // Generator 2 PWM Module Trigger
               // Select
#define ADC_TSSEL_PS2_0                                                        \
    0x00000000 // Use Generator 2 (and its
               // trigger) in PWM module 0
#define ADC_TSSEL_PS2_1                                                        \
    0x00100000 // Use Generator 2 (and its
               // trigger) in PWM module 1
#define ADC_TSSEL_PS1_M                                                        \
    0x00003000 // Generator 1 PWM Module Trigger
               // Select
#define ADC_TSSEL_PS1_0                                                        \
    0x00000000 // Use Generator 1 (and its
               // trigger) in PWM module 0
#define ADC_TSSEL_PS1_1                                                        \
    0x00001000 // Use Generator 1 (and its
               // trigger) in PWM module 1
#define ADC_TSSEL_PS0_M                                                        \
    0x00000030 // Generator 0 PWM Module Trigger
               // Select
#define ADC_TSSEL_PS0_0                                                        \
    0x00000000 // Use Generator 0 (and its
               // trigger) in PWM module 0
#define ADC_TSSEL_PS0_1                                                        \
    0x00000010 // Use Generator 0 (and its
               // trigger) in PWM module 1
...
//
//*****************************************************************************
#define ADC_DCISC_DCINT7                                                       \
    0x00000080 // Digital Comparator 7 Interrupt
               // Status and Clear
#define ADC_DCISC_DCINT6                                                       \
    0x00000040 // Digital Comparator 6 Interrupt
               // Status and Clear
#define ADC_DCISC_DCINT5                                                       \
    0x00000020 // Digital Comparator 5 Interrupt
               // Status and Clear
#define ADC_DCISC_DCINT4                                                       \
    0x00000010 // Digital Comparator 4 Interrupt
               // Status and Clear
#define ADC_DCISC_DCINT3                                                       \
    0x00000008 // Digital Comparator 3 Interrupt
               // Status and Clear
#define ADC_DCISC_DCINT2                                                       \
    0x00000004 // Digital Comparator 2 Interrupt
               // Status and Clear
#define ADC_DCISC_DCINT1                                                       \
    0x00000002 // Digital Comparator 1 Interrupt
               // Status and Clear
#define ADC_DCISC_DCINT0                                                       \
    0x00000001 // Digital Comparator 0 Interrupt
               // Status and Clear
...
#define ADC_SSCTL0_D6                                                          \
    0x01000000                     // 7th Sample Differential Input
                                   // Select
...
#define ADC_SSCTL0_D5                                                          \
    0x00100000                     // 6th Sample Differential Input
                                   // Select
...
#define ADC_SSCTL0_D4                                                          \
    0x00010000                     // 5th Sample Differential Input
                                   // Select
...
#define ADC_SSCTL0_D2                                                          \
    0x00000100                     // 3rd Sample Differential Input
                                   // Select
...
#define ADC_SSCTL0_D1                                                          \
    0x00000010                     // 2nd Sample Differential Input
                                   // Select
...
//
//*****************************************************************************
#define ADC_SSOP0_S7DCOP                                                       \
    0x10000000 // Sample 7 Digital Comparator
               // Operation
#define ADC_SSOP0_S6DCOP                                                       \
    0x01000000 // Sample 6 Digital Comparator
               // Operation
#define ADC_SSOP0_S5DCOP                                                       \
    0x00100000 // Sample 5 Digital Comparator
               // Operation
#define ADC_SSOP0_S4DCOP                                                       \
    0x00010000 // Sample 4 Digital Comparator
               // Operation
#define ADC_SSOP0_S3DCOP                                                       \
    0x00001000 // Sample 3 Digital Comparator
               // Operation
#define ADC_SSOP0_S2DCOP                                                       \
    0x00000100 // Sample 2 Digital Comparator
               // Operation
#define ADC_SSOP0_S1DCOP                                                       \
    0x00000010 // Sample 1 Digital Comparator
               // Operation
#define ADC_SSOP0_S0DCOP                                                       \
    0x00000001 // Sample 0 Digital Comparator
               // Operation
...
//
//*****************************************************************************
#define ADC_SSDC0_S7DCSEL_M                                                    \
    0xF0000000 // Sample 7 Digital Comparator
               // Select
#define ADC_SSDC0_S6DCSEL_M                                                    \
    0x0F000000 // Sample 6 Digital Comparator
               // Select
#define ADC_SSDC0_S5DCSEL_M                                                    \
    0x00F00000 // Sample 5 Digital Comparator
               // Select
#define ADC_SSDC0_S4DCSEL_M                                                    \
    0x000F0000 // Sample 4 Digital Comparator
               // Select
#define ADC_SSDC0_S3DCSEL_M                                                    \
    0x0000F000 // Sample 3 Digital Comparator
               // Select
#define ADC_SSDC0_S2DCSEL_M                                                    \
    0x00000F00 // Sample 2 Digital Comparator
               // Select
#define ADC_SSDC0_S1DCSEL_M                                                    \
    0x000000F0 // Sample 1 Digital Comparator
               // Select
#define ADC_SSDC0_S0DCSEL_M                                                    \
    0x0000000F // Sample 0 Digital Comparator
               // Select
...
//
//*****************************************************************************
#define ADC_SSOP1_S3DCOP                                                       \
    0x00001000 // Sample 3 Digital Comparator
               // Operation
#define ADC_SSOP1_S2DCOP                                                       \
    0x00000100 // Sample 2 Digital Comparator
               // Operation
#define ADC_SSOP1_S1DCOP                                                       \
    0x00000010 // Sample 1 Digital Comparator
               // Operation
#define ADC_SSOP1_S0DCOP                                                       \
    0x00000001 // Sample 0 Digital Comparator
               // Operation
...
//
//*****************************************************************************
#define ADC_SSDC1_S3DCSEL_M                                                    \
    0x0000F000 // Sample 3 Digital Comparator
               // Select
#define ADC_SSDC1_S2DCSEL_M                                                    \
    0x00000F00 // Sample 2 Digital Comparator
               // Select
#define ADC_SSDC1_S1DCSEL_M                                                    \
    0x000000F0 // Sample 1 Digital Comparator
               // Select
#define ADC_SSDC1_S0DCSEL_M                                                    \
    0x0000000F // Sample 0 Digital Comparator
               // Select
...
//
//*****************************************************************************
#define ADC_SSOP2_S3DCOP                                                       \
    0x00001000 // Sample 3 Digital Comparator
               // Operation
#define ADC_SSOP2_S2DCOP                                                       \
    0x00000100 // Sample 2 Digital Comparator
               // Operation
#define ADC_SSOP2_S1DCOP                                                       \
    0x00000010 // Sample 1 Digital Comparator
               // Operation
#define ADC_SSOP2_S0DCOP                                                       \
    0x00000001 // Sample 0 Digital Comparator
               // Operation
...
//
//*****************************************************************************
#define ADC_SSDC2_S3DCSEL_M                                                    \
    0x0000F000 // Sample 3 Digital Comparator
               // Select
#define ADC_SSDC2_S2DCSEL_M                                                    \
    0x00000F00 // Sample 2 Digital Comparator
               // Select
#define ADC_SSDC2_S1DCSEL_M                                                    \
    0x000000F0 // Sample 1 Digital Comparator
               // Select
#define ADC_SSDC2_S0DCSEL_M                                                    \
    0x0000000F // Sample 0 Digital Comparator
               // Select
...
//
//*****************************************************************************
#define COMP_ACMIS_IN1                                                         \
    0x00000002 // Comparator 1 Masked Interrupt
               // Status
#define COMP_ACMIS_IN0                                                         \
    0x00000001 // Comparator 0 Masked Interrupt
               // Status
...
#define CAN_STS_TXOK                                                           \
    0x00000008                         // Transmitted a Message
                                       // Successfully
...
#define USB_TXIE_EP0                                                           \
    0x00000001 // TX and RX Endpoint 0 Interrupt
               // Enable
...
//
//*****************************************************************************
#define USB_IE_VBUSERR                                                         \
    0x00000080 // Enable VBUS Error Interrupt (OTG
               // only)
#define USB_IE_SESREQ                                                          \
    0x00000040                   // Enable Session Request (OTG
                                 // only)
...
//
//*****************************************************************************
#define USB_TXINTERVAL1_NAKLMT_M 0x000000FF // NAK Limit
#define USB_TXINTERVAL1_TXPOLL_M 0x000000FF // TX Polling
...
#define USB_RXINTERVAL1_NAKLMT_M 0x000000FF // NAK Limit
...
//
//*****************************************************************************
#define USB_TXINTERVAL2_TXPOLL_M 0x000000FF // TX Polling
#define USB_TXINTERVAL2_NAKLMT_M 0x000000FF // NAK Limit
...
//
//*****************************************************************************
#define USB_RXINTERVAL2_TXPOLL_M 0x000000FF // RX Polling
#define USB_RXINTERVAL2_NAKLMT_M 0x000000FF // NAK Limit
...
//
//*****************************************************************************
#define USB_TXINTERVAL3_TXPOLL_M 0x000000FF // TX Polling
#define USB_TXINTERVAL3_NAKLMT_M 0x000000FF // NAK Limit
...
//
//*****************************************************************************
#define USB_RXINTERVAL3_TXPOLL_M 0x000000FF // RX Polling
#define USB_RXINTERVAL3_NAKLMT_M 0x000000FF // NAK Limit
...
//
//*****************************************************************************
#define USB_TXINTERVAL4_TXPOLL_M 0x000000FF // TX Polling
#define USB_TXINTERVAL4_NAKLMT_M 0x000000FF // NAK Limit
...
//
//*****************************************************************************
#define USB_RXINTERVAL4_TXPOLL_M 0x000000FF // RX Polling
#define USB_RXINTERVAL4_NAKLMT_M 0x000000FF // NAK Limit
...
//
//*****************************************************************************
#define USB_TXINTERVAL5_TXPOLL_M 0x000000FF // TX Polling
#define USB_TXINTERVAL5_NAKLMT_M 0x000000FF // NAK Limit
...
//
//*****************************************************************************
#define USB_RXINTERVAL5_TXPOLL_M 0x000000FF // RX Polling
#define USB_RXINTERVAL5_NAKLMT_M 0x000000FF // NAK Limit
...
//
//*****************************************************************************
#define USB_TXINTERVAL6_TXPOLL_M 0x000000FF // TX Polling
#define USB_TXINTERVAL6_NAKLMT_M 0x000000FF // NAK Limit
...
//
//*****************************************************************************
#define USB_RXINTERVAL6_TXPOLL_M 0x000000FF // RX Polling
#define USB_RXINTERVAL6_NAKLMT_M 0x000000FF // NAK Limit
...
//
//*****************************************************************************
#define USB_TXINTERVAL7_TXPOLL_M 0x000000FF // TX Polling
#define USB_TXINTERVAL7_NAKLMT_M 0x000000FF // NAK Limit
...
//
//*****************************************************************************
#define USB_RXINTERVAL7_TXPOLL_M 0x000000FF // RX Polling
#define USB_RXINTERVAL7_NAKLMT_M 0x000000FF // NAK Limit
...
//
//*****************************************************************************
#define USB_RXDPKTBUFDIS_EP7                                                   \
    0x00000080 // EP7 RX Double-Packet Buffer
               // Disable
#define USB_RXDPKTBUFDIS_EP6                                                   \
    0x00000040 // EP6 RX Double-Packet Buffer
               // Disable
#define USB_RXDPKTBUFDIS_EP5                                                   \
    0x00000020 // EP5 RX Double-Packet Buffer
               // Disable
#define USB_RXDPKTBUFDIS_EP4                                                   \
    0x00000010 // EP4 RX Double-Packet Buffer
               // Disable
#define USB_RXDPKTBUFDIS_EP3                                                   \
    0x00000008 // EP3 RX Double-Packet Buffer
               // Disable
#define USB_RXDPKTBUFDIS_EP2                                                   \
    0x00000004 // EP2 RX Double-Packet Buffer
               // Disable
#define USB_RXDPKTBUFDIS_EP1                                                   \
    0x00000002 // EP1 RX Double-Packet Buffer
               // Disable
...
//
//*****************************************************************************
#define USB_TXDPKTBUFDIS_EP7                                                   \
    0x00000080 // EP7 TX Double-Packet Buffer
               // Disable
#define USB_TXDPKTBUFDIS_EP6                                                   \
    0x00000040 // EP6 TX Double-Packet Buffer
               // Disable
#define USB_TXDPKTBUFDIS_EP5                                                   \
    0x00000020 // EP5 TX Double-Packet Buffer
               // Disable
#define USB_TXDPKTBUFDIS_EP4                                                   \
    0x00000010 // EP4 TX Double-Packet Buffer
               // Disable
#define USB_TXDPKTBUFDIS_EP3                                                   \
    0x00000008 // EP3 TX Double-Packet Buffer
               // Disable
#define USB_TXDPKTBUFDIS_EP2                                                   \
    0x00000004 // EP2 TX Double-Packet Buffer
               // Disable
#define USB_TXDPKTBUFDIS_EP1                                                   \
    0x00000002 // EP1 TX Double-Packet Buffer
               // Disable
...
#define USB_EPC_EPEN_M                                                         \
    0x00000003                       // External Power Supply Enable
                                     // Configuration
#define USB_EPC_EPEN_LOW 0x00000000  // Power Enable Active Low
#define USB_EPC_EPEN_HIGH 0x00000001 // Power Enable Active High
#define USB_EPC_EPEN_VBLOW                                                     \
    0x00000002 // Power Enable High if VBUS Low
               // (OTG only)
#define USB_EPC_EPEN_VBHIGH                                                    \
    0x00000003 // Power Enable High if VBUS High
               // (OTG only)
...
#define USB_EPCISC_PF                                                          \
    0x00000001 // USB Power Fault Interrupt Status
               // and Clear
...
#define USB_DRISC_RESUME                                                       \
    0x00000001 // RESUME Interrupt Status and
               // Clear
...
#define USB_VDCISC_VD                                                          \
    0x00000001 // VBUS Droop Interrupt Status and
               // Clear
...
#define USB_IDVRIS_ID                                                          \
    0x00000001 // ID Valid Detect Raw Interrupt
               // Status
...
#define USB_IDVISC_ID                                                          \
    0x00000001 // ID Valid Detect Interrupt Status
               // and Clear
...
#define USB_PP_TYPE_0                                                          \
    0x00000000 // The first-generation USB
               // controller
...
#define EEPROM_EEPROT_PROT_RWNPW                                               \
    0x00000000 // This setting is the default. If
               ...
               // and writable
#define EEPROM_EEPROT_PROT_RWPW                                                \
    0x00000001 // If there is a password, the
...
//
//*****************************************************************************
#define SYSEXC_RIS_FPIXCRIS                                                    \
    0x00000020 // Floating-Point Inexact Exception
               // Raw Interrupt Status
#define SYSEXC_RIS_FPOFCRIS                                                    \
    0x00000010 // Floating-Point Overflow
               // Exception Raw Interrupt Status
#define SYSEXC_RIS_FPUFCRIS                                                    \
    0x00000008 // Floating-Point Underflow
               // Exception Raw Interrupt Status
#define SYSEXC_RIS_FPIOCRIS                                                    \
    0x00000004 // Floating-Point Invalid Operation
               // Raw Interrupt Status
#define SYSEXC_RIS_FPDZCRIS                                                    \
    0x00000002 // Floating-Point Divide By 0
               // Exception Raw Interrupt Status
#define SYSEXC_RIS_FPIDCRIS                                                    \
...
//
//*****************************************************************************
#define SYSEXC_IM_FPIXCIM                                                      \
    0x00000020 // Floating-Point Inexact Exception
               // Interrupt Mask
#define SYSEXC_IM_FPOFCIM                                                      \
    0x00000010 // Floating-Point Overflow
               // Exception Interrupt Mask
#define SYSEXC_IM_FPUFCIM                                                      \
    0x00000008 // Floating-Point Underflow
               // Exception Interrupt Mask
#define SYSEXC_IM_FPIOCIM                                                      \
    0x00000004 // Floating-Point Invalid Operation
               // Interrupt Mask
#define SYSEXC_IM_FPDZCIM                                                      \
    0x00000002 // Floating-Point Divide By 0
               // Exception Interrupt Mask
#define SYSEXC_IM_FPIDCIM                                                      \
    0x00000001 // Floating-Point Input Denormal
               // Exception Interrupt Mask
...
//
//*****************************************************************************
#define SYSEXC_MIS_FPIXCMIS                                                    \
    0x00000020 // Floating-Point Inexact Exception
               // Masked Interrupt Status
#define SYSEXC_MIS_FPOFCMIS                                                    \
    0x00000010 // Floating-Point Overflow
               // Exception Masked Interrupt
               // Status
#define SYSEXC_MIS_FPUFCMIS                                                    \
    0x00000008 // Floating-Point Underflow
               // Exception Masked Interrupt
               // Status
#define SYSEXC_MIS_FPIOCMIS                                                    \
    0x00000004 // Floating-Point Invalid Operation
               // Masked Interrupt Status
#define SYSEXC_MIS_FPDZCMIS                                                    \
    0x00000002 // Floating-Point Divide By 0
               // Exception Masked Interrupt
               // Status
#define SYSEXC_MIS_FPIDCMIS                                                    \
    0x00000001 // Floating-Point Input Denormal
               // Exception Masked Interrupt
               // Status
...
//
//*****************************************************************************
#define SYSEXC_IC_FPIXCIC                                                      \
    0x00000020 // Floating-Point Inexact Exception
               // Interrupt Clear
#define SYSEXC_IC_FPOFCIC                                                      \
    0x00000010 // Floating-Point Overflow
               // Exception Interrupt Clear
#define SYSEXC_IC_FPUFCIC                                                      \
    0x00000008 // Floating-Point Underflow
               // Exception Interrupt Clear
#define SYSEXC_IC_FPIOCIC                                                      \
    0x00000004 // Floating-Point Invalid Operation
               // Interrupt Clear
#define SYSEXC_IC_FPDZCIC                                                      \
    0x00000002 // Floating-Point Divide By 0
               // Exception Interrupt Clear
#define SYSEXC_IC_FPIDCIC                                                      \
    0x00000001 // Floating-Point Input Denormal
               // Exception Interrupt Clear
...
#define FLASH_FCRIS_ERRIS                                                      \
    0x00000800 // Erase Verify Error Raw Interrupt
               // Status
...
#define SYSCTL_DID0_VER_1                                                      \
    0x10000000                         // Second version of the DID0
                                       // register format.
...
#define SYSCTL_DID0_MAJ_REVB                                                   \
    0x00000100 // Revision B (first base layer
               // revision)
#define SYSCTL_DID0_MAJ_REVC                                                   \
    0x00000200                       // Revision C (second base layer
                                     // revision)
#define SYSCTL_DID0_MIN_M 0x000000FF // Minor Revision
#define SYSCTL_DID0_MIN_0                                                      \
    0x00000000                       // Initial device, or a major
                                     // revision update
...
#define SYSCTL_DID1_PRTNO_TM4C123GH6PM 0x00A10000 // TM4C123GH6PM
...
#define SYSCTL_DID1_TEMP_IE                                                    \
    0x00000060                         // Available in both industrial
...
//
//*****************************************************************************
#define SYSCTL_RIS_BOR0RIS                                                     \
    0x00000800 // VDD under BOR0 Raw Interrupt
               // Status
#define SYSCTL_RIS_VDDARIS                                                     \
    0x00000400 // VDDA Power OK Event Raw
               // Interrupt Status
#define SYSCTL_RIS_MOSCPUPRIS                                                  \
    0x00000100 // MOSC Power Up Raw Interrupt
               // Status
#define SYSCTL_RIS_USBPLLLRIS                                                  \
    0x00000080                        // USB PLL Lock Raw Interrupt
                                      // Status
#define SYSCTL_RIS_PLLLRIS 0x00000040 // PLL Lock Raw Interrupt Status
#define SYSCTL_RIS_MOFRIS                                                      \
    0x00000008 // Main Oscillator Failure Raw
               // Interrupt Status
#define SYSCTL_RIS_BOR1RIS                                                     \
    0x00000002 // VDD under BOR1 Raw Interrupt
               // Status
...
#define SYSCTL_IMC_MOFIM                                                       \
    0x00000008                       // Main Oscillator Failure
                                     // Interrupt Mask
...
//
//*****************************************************************************
#define SYSCTL_MISC_BOR0MIS                                                    \
    0x00000800 // VDD under BOR0 Masked Interrupt
               // Status
#define SYSCTL_MISC_VDDAMIS                                                    \
    0x00000400 // VDDA Power OK Masked Interrupt
               // Status
#define SYSCTL_MISC_MOSCPUPMIS                                                 \
    0x00000100 // MOSC Power Up Masked Interrupt
               // Status
#define SYSCTL_MISC_USBPLLLMIS                                                 \
    0x00000080                         // USB PLL Lock Masked Interrupt
                                       // Status
#define SYSCTL_MISC_PLLLMIS 0x00000040 // PLL Lock Masked Interrupt Status
#define SYSCTL_MISC_MOFMIS                                                     \
    0x00000008 // Main Oscillator Failure Masked
               // Interrupt Status
#define SYSCTL_MISC_BOR1MIS                                                    \
    0x00000002 // VDD under BOR1 Masked Interrupt
               // Status
...
//
//*****************************************************************************
#define SYSCTL_GPIOHBCTL_PORTF                                                 \
    0x00000020 // Port F Advanced High-Performance
               // Bus
#define SYSCTL_GPIOHBCTL_PORTE                                                 \
    0x00000010 // Port E Advanced High-Performance
               // Bus
#define SYSCTL_GPIOHBCTL_PORTD                                                 \
    0x00000008 // Port D Advanced High-Performance
               // Bus
#define SYSCTL_GPIOHBCTL_PORTC                                                 \
    0x00000004 // Port C Advanced High-Performance
               // Bus
#define SYSCTL_GPIOHBCTL_PORTB                                                 \
    0x00000002 // Port B Advanced High-Performance
               // Bus
#define SYSCTL_GPIOHBCTL_PORTA                                                 \
    0x00000001 // Port A Advanced High-Performance
               // Bus
...
#define SYSCTL_RCC2_DIV400                                                     \
    0x40000000                             // Divide PLL as 400 MHz vs. 200
                                           // MHz
...
#define SYSCTL_PIOSCSTAT_CRNONE                                                \
    0x00000000 // Calibration has not been
               // attempted
#define SYSCTL_PIOSCSTAT_CRPASS                                                \
    0x00000100 // The last calibration operation
               // completed to meet 1% accuracy
#define SYSCTL_PIOSCSTAT_CRFAIL                                                \
    0x00000200                           // The last calibration operation
...
//
//*****************************************************************************
#define SYSCTL_SLPPWRCFG_FLASHPM_M 0x00000030   // Flash Power Modes
#define SYSCTL_SLPPWRCFG_FLASHPM_NRM 0x00000000 // Active Mode
#define SYSCTL_SLPPWRCFG_FLASHPM_SLP 0x00000020 // Low Power Mode
#define SYSCTL_SLPPWRCFG_SRAMPM_M 0x00000003    // SRAM Power Modes
...
//
//*****************************************************************************
#define SYSCTL_DSLPPWRCFG_FLASHPM_M 0x00000030   // Flash Power Modes
...
#define SYSCTL_DSLPPWRCFG_SRAMPM_M 0x00000003    // SRAM Power Modes
...
//
//*****************************************************************************
#define SYSCTL_NVMSTAT_FWB                                                     \
    0x00000001 // 32 Word Flash Write Buffer
               // Available
...
//
//*****************************************************************************
#define SYSCTL_PPTIMER_P5                                                      \
    0x00000020 // 16/32-Bit General-Purpose Timer
               // 5 Present
#define SYSCTL_PPTIMER_P4                                                      \
    0x00000010 // 16/32-Bit General-Purpose Timer
               // 4 Present
#define SYSCTL_PPTIMER_P3                                                      \
    0x00000008 // 16/32-Bit General-Purpose Timer
               // 3 Present
#define SYSCTL_PPTIMER_P2                                                      \
    0x00000004 // 16/32-Bit General-Purpose Timer
               // 2 Present
#define SYSCTL_PPTIMER_P1                                                      \
    0x00000002 // 16/32-Bit General-Purpose Timer
               // 1 Present
#define SYSCTL_PPTIMER_P0                                                      \
    0x00000001 // 16/32-Bit General-Purpose Timer
               // 0 Present
...
//
//*****************************************************************************
#define SYSCTL_PPWTIMER_P5                                                     \
    0x00000020 // 32/64-Bit Wide General-Purpose
               // Timer 5 Present
#define SYSCTL_PPWTIMER_P4                                                     \
    0x00000010 // 32/64-Bit Wide General-Purpose
               // Timer 4 Present
#define SYSCTL_PPWTIMER_P3                                                     \
    0x00000008 // 32/64-Bit Wide General-Purpose
               // Timer 3 Present
#define SYSCTL_PPWTIMER_P2                                                     \
    0x00000004 // 32/64-Bit Wide General-Purpose
               // Timer 2 Present
#define SYSCTL_PPWTIMER_P1                                                     \
    0x00000002 // 32/64-Bit Wide General-Purpose
               // Timer 1 Present
#define SYSCTL_PPWTIMER_P0                                                     \
    0x00000001 // 32/64-Bit Wide General-Purpose
               // Timer 0 Present
...
//
//*****************************************************************************
#define SYSCTL_SRTIMER_R5                                                      \
    0x00000020 // 16/32-Bit General-Purpose Timer
               // 5 Software Reset
#define SYSCTL_SRTIMER_R4                                                      \
    0x00000010 // 16/32-Bit General-Purpose Timer
               // 4 Software Reset
#define SYSCTL_SRTIMER_R3                                                      \
    0x00000008 // 16/32-Bit General-Purpose Timer
               // 3 Software Reset
#define SYSCTL_SRTIMER_R2                                                      \
    0x00000004 // 16/32-Bit General-Purpose Timer
               // 2 Software Reset
#define SYSCTL_SRTIMER_R1                                                      \
    0x00000002 // 16/32-Bit General-Purpose Timer
               // 1 Software Reset
#define SYSCTL_SRTIMER_R0                                                      \
    0x00000001 // 16/32-Bit General-Purpose Timer
               // 0 Software Reset
...
//
//*****************************************************************************
#define SYSCTL_SRHIB_R0                                                        \
    0x00000001 // Hibernation Module Software
               // Reset
...
//
//*****************************************************************************
#define SYSCTL_SRACMP_R0                                                       \
    0x00000001 // Analog Comparator Module 0
               // Software Reset
...
//
//*****************************************************************************
#define SYSCTL_SRWTIMER_R5                                                     \
    0x00000020 // 32/64-Bit Wide General-Purpose
               // Timer 5 Software Reset
#define SYSCTL_SRWTIMER_R4                                                     \
    0x00000010 // 32/64-Bit Wide General-Purpose
               // Timer 4 Software Reset
#define SYSCTL_SRWTIMER_R3                                                     \
    0x00000008 // 32/64-Bit Wide General-Purpose
               // Timer 3 Software Reset
#define SYSCTL_SRWTIMER_R2                                                     \
    0x00000004 // 32/64-Bit Wide General-Purpose
               // Timer 2 Software Reset
#define SYSCTL_SRWTIMER_R1                                                     \
    0x00000002 // 32/64-Bit Wide General-Purpose
               // Timer 1 Software Reset
#define SYSCTL_SRWTIMER_R0                                                     \
    0x00000001 // 32/64-Bit Wide General-Purpose
...
//
//*****************************************************************************
#define SYSCTL_RCGCWD_R1                                                       \
    0x00000002 // Watchdog Timer 1 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCWD_R0                                                       \
    0x00000001 // Watchdog Timer 0 Run Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_RCGCTIMER_R5                                                    \
    0x00000020 // 16/32-Bit General-Purpose Timer
               // 5 Run Mode Clock Gating Control
#define SYSCTL_RCGCTIMER_R4                                                    \
    0x00000010 // 16/32-Bit General-Purpose Timer
               // 4 Run Mode Clock Gating Control
#define SYSCTL_RCGCTIMER_R3                                                    \
    0x00000008 // 16/32-Bit General-Purpose Timer
               // 3 Run Mode Clock Gating Control
#define SYSCTL_RCGCTIMER_R2                                                    \
    0x00000004 // 16/32-Bit General-Purpose Timer
               // 2 Run Mode Clock Gating Control
#define SYSCTL_RCGCTIMER_R1                                                    \
    0x00000002 // 16/32-Bit General-Purpose Timer
               // 1 Run Mode Clock Gating Control
#define SYSCTL_RCGCTIMER_R0                                                    \
    0x00000001 // 16/32-Bit General-Purpose Timer
...
#define SYSCTL_RCGCGPIO_R5                                                     \
    0x00000020 // GPIO Port F Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCGPIO_R4                                                     \
    0x00000010 // GPIO Port E Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCGPIO_R3                                                     \
    0x00000008 // GPIO Port D Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCGPIO_R2                                                     \
    0x00000004 // GPIO Port C Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCGPIO_R1                                                     \
    0x00000002 // GPIO Port B Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCGPIO_R0                                                     \
    0x00000001 // GPIO Port A Run Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_RCGCDMA_R0                                                      \
    0x00000001 // uDMA Module Run Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_RCGCHIB_R0                                                      \
    0x00000001 // Hibernation Module Run Mode
...
//
//*****************************************************************************
#define SYSCTL_RCGCUART_R7                                                     \
    0x00000080 // UART Module 7 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCUART_R6                                                     \
    0x00000040 // UART Module 6 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCUART_R5                                                     \
    0x00000020 // UART Module 5 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCUART_R4                                                     \
    0x00000010 // UART Module 4 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCUART_R3                                                     \
    0x00000008 // UART Module 3 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCUART_R2                                                     \
    0x00000004 // UART Module 2 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCUART_R1                                                     \
    0x00000002 // UART Module 1 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCUART_R0                                                     \
    0x00000001 // UART Module 0 Run Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_RCGCSSI_R3                                                      \
    0x00000008 // SSI Module 3 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCSSI_R2                                                      \
    0x00000004 // SSI Module 2 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCSSI_R1                                                      \
    0x00000002 // SSI Module 1 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCSSI_R0                                                      \
    0x00000001 // SSI Module 0 Run Mode Clock
               // Gating Control
...
#define SYSCTL_RCGCI2C_R3                                                      \
    0x00000008 // I2C Module 3 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCI2C_R2                                                      \
    0x00000004 // I2C Module 2 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCI2C_R1                                                      \
    0x00000002 // I2C Module 1 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCI2C_R0                                                      \
    0x00000001 // I2C Module 0 Run Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_RCGCUSB_R0                                                      \
    0x00000001 // USB Module Run Mode Clock Gating
               // Control
...
//
//*****************************************************************************
#define SYSCTL_RCGCCAN_R1                                                      \
    0x00000002 // CAN Module 1 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCCAN_R0                                                      \
    0x00000001 // CAN Module 0 Run Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_RCGCADC_R1                                                      \
    0x00000002 // ADC Module 1 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCADC_R0                                                      \
    0x00000001 // ADC Module 0 Run Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_RCGCACMP_R0                                                     \
    0x00000001 // Analog Comparator Module 0 Run
...
//
//*****************************************************************************
#define SYSCTL_RCGCPWM_R1                                                      \
    0x00000002 // PWM Module 1 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCPWM_R0                                                      \
    0x00000001 // PWM Module 0 Run Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_RCGCQEI_R1                                                      \
    0x00000002 // QEI Module 1 Run Mode Clock
               // Gating Control
#define SYSCTL_RCGCQEI_R0                                                      \
    0x00000001 // QEI Module 0 Run Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_RCGCEEPROM_R0                                                   \
    0x00000001 // EEPROM Module Run Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_RCGCWTIMER_R5                                                   \
    0x00000020 // 32/64-Bit Wide General-Purpose
               // Timer 5 Run Mode Clock Gating
               // Control
#define SYSCTL_RCGCWTIMER_R4                                                   \
    0x00000010 // 32/64-Bit Wide General-Purpose
               // Timer 4 Run Mode Clock Gating
               // Control
#define SYSCTL_RCGCWTIMER_R3                                                   \
    0x00000008 // 32/64-Bit Wide General-Purpose
               // Timer 3 Run Mode Clock Gating
               // Control
#define SYSCTL_RCGCWTIMER_R2                                                   \
    0x00000004 // 32/64-Bit Wide General-Purpose
               // Timer 2 Run Mode Clock Gating
               // Control
#define SYSCTL_RCGCWTIMER_R1                                                   \
    0x00000002 // 32/64-Bit Wide General-Purpose
...
//
//*****************************************************************************
#define SYSCTL_SCGCWD_S1                                                       \
    0x00000002 // Watchdog Timer 1 Sleep Mode
               // Clock Gating Control
#define SYSCTL_SCGCWD_S0                                                       \
    0x00000001 // Watchdog Timer 0 Sleep Mode
               // Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_SCGCTIMER_S5                                                    \
    0x00000020 // 16/32-Bit General-Purpose Timer
               // 5 Sleep Mode Clock Gating
               // Control
#define SYSCTL_SCGCTIMER_S4                                                    \
    0x00000010 // 16/32-Bit General-Purpose Timer
               // 4 Sleep Mode Clock Gating
               // Control
#define SYSCTL_SCGCTIMER_S3                                                    \
    0x00000008 // 16/32-Bit General-Purpose Timer
               // 3 Sleep Mode Clock Gating
               // Control
#define SYSCTL_SCGCTIMER_S2                                                    \
    0x00000004 // 16/32-Bit General-Purpose Timer
               // 2 Sleep Mode Clock Gating
               // Control
#define SYSCTL_SCGCTIMER_S1                                                    \
    0x00000002 // 16/32-Bit General-Purpose Timer
               // 1 Sleep Mode Clock Gating
               // Control
#define SYSCTL_SCGCTIMER_S0                                                    \
    0x00000001 // 16/32-Bit General-Purpose Timer
...
//
//*****************************************************************************
#define SYSCTL_SCGCGPIO_S5                                                     \
    0x00000020 // GPIO Port F Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCGPIO_S4                                                     \
    0x00000010 // GPIO Port E Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCGPIO_S3                                                     \
    0x00000008 // GPIO Port D Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCGPIO_S2                                                     \
    0x00000004 // GPIO Port C Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCGPIO_S1                                                     \
    0x00000002 // GPIO Port B Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCGPIO_S0                                                     \
    0x00000001 // GPIO Port A Sleep Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_SCGCDMA_S0                                                      \
    0x00000001 // uDMA Module Sleep Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_SCGCHIB_S0                                                      \
    0x00000001 // Hibernation Module Sleep Mode
               // Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_SCGCUART_S7                                                     \
    0x00000080 // UART Module 7 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCUART_S6                                                     \
    0x00000040 // UART Module 6 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCUART_S5                                                     \
    0x00000020 // UART Module 5 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCUART_S4                                                     \
    0x00000010 // UART Module 4 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCUART_S3                                                     \
    0x00000008 // UART Module 3 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCUART_S2                                                     \
    0x00000004 // UART Module 2 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCUART_S1                                                     \
    0x00000002 // UART Module 1 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCUART_S0                                                     \
    0x00000001 // UART Module 0 Sleep Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_SCGCSSI_S3                                                      \
    0x00000008 // SSI Module 3 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCSSI_S2                                                      \
    0x00000004 // SSI Module 2 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCSSI_S1                                                      \
    0x00000002 // SSI Module 1 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCSSI_S0                                                      \
    0x00000001 // SSI Module 0 Sleep Mode Clock
               // Gating Control
...
#define SYSCTL_SCGCI2C_S3                                                      \
    0x00000008 // I2C Module 3 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCI2C_S2                                                      \
    0x00000004 // I2C Module 2 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCI2C_S1                                                      \
    0x00000002 // I2C Module 1 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCI2C_S0                                                      \
    0x00000001 // I2C Module 0 Sleep Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_SCGCUSB_S0                                                      \
    0x00000001 // USB Module Sleep Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_SCGCCAN_S1                                                      \
    0x00000002 // CAN Module 1 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCCAN_S0                                                      \
    0x00000001 // CAN Module 0 Sleep Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_SCGCADC_S1                                                      \
    0x00000002 // ADC Module 1 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCADC_S0                                                      \
    0x00000001 // ADC Module 0 Sleep Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_SCGCACMP_S0                                                     \
    0x00000001 // Analog Comparator Module 0 Sleep
               // Mode Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_SCGCPWM_S1                                                      \
    0x00000002 // PWM Module 1 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCPWM_S0                                                      \
    0x00000001 // PWM Module 0 Sleep Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_SCGCQEI_S1                                                      \
    0x00000002 // QEI Module 1 Sleep Mode Clock
               // Gating Control
#define SYSCTL_SCGCQEI_S0                                                      \
    0x00000001 // QEI Module 0 Sleep Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_SCGCEEPROM_S0                                                   \
    0x00000001 // EEPROM Module Sleep Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_SCGCWTIMER_S5                                                   \
    0x00000020 // 32/64-Bit Wide General-Purpose
               // Timer 5 Sleep Mode Clock Gating
               // Control
#define SYSCTL_SCGCWTIMER_S4                                                   \
    0x00000010 // 32/64-Bit Wide General-Purpose
               // Timer 4 Sleep Mode Clock Gating
               // Control
#define SYSCTL_SCGCWTIMER_S3                                                   \
    0x00000008 // 32/64-Bit Wide General-Purpose
               // Timer 3 Sleep Mode Clock Gating
               // Control
#define SYSCTL_SCGCWTIMER_S2                                                   \
    0x00000004 // 32/64-Bit Wide General-Purpose
...
//
//*****************************************************************************
#define SYSCTL_DCGCWD_D1                                                       \
    0x00000002 // Watchdog Timer 1 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCWD_D0                                                       \
    0x00000001 // Watchdog Timer 0 Deep-Sleep Mode
               // Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_DCGCTIMER_D5                                                    \
    0x00000020 // 16/32-Bit General-Purpose Timer
               // 5 Deep-Sleep Mode Clock Gating
               // Control
#define SYSCTL_DCGCTIMER_D4                                                    \
    0x00000010 // 16/32-Bit General-Purpose Timer
               // 4 Deep-Sleep Mode Clock Gating
               // Control
#define SYSCTL_DCGCTIMER_D3                                                    \
    0x00000008 // 16/32-Bit General-Purpose Timer
...
#define SYSCTL_DCGCTIMER_D2                                                    \
    0x00000004 // 16/32-Bit General-Purpose Timer
               ...
               // Control
#define SYSCTL_DCGCTIMER_D1                                                    \
    0x00000002 // 16/32-Bit General-Purpose Timer
               // 1 Deep-Sleep Mode Clock Gating
               // Control
#define SYSCTL_DCGCTIMER_D0                                                    \
    0x00000001 // 16/32-Bit General-Purpose Timer
...
#define SYSCTL_DCGCGPIO_D5                                                     \
    0x00000020 // GPIO Port F Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCGPIO_D4                                                     \
    0x00000010 // GPIO Port E Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCGPIO_D3                                                     \
    0x00000008 // GPIO Port D Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCGPIO_D2                                                     \
    0x00000004 // GPIO Port C Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCGPIO_D1                                                     \
    0x00000002 // GPIO Port B Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCGPIO_D0                                                     \
    0x00000001 // GPIO Port A Deep-Sleep Mode
               // Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_DCGCDMA_D0                                                      \
    0x00000001 // uDMA Module Deep-Sleep Mode
               // Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_DCGCHIB_D0                                                      \
    0x00000001 // Hibernation Module Deep-Sleep
               // Mode Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_DCGCUART_D7                                                     \
    0x00000080 // UART Module 7 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCUART_D6                                                     \
    0x00000040 // UART Module 6 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCUART_D5                                                     \
    0x00000020 // UART Module 5 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCUART_D4                                                     \
    0x00000010 // UART Module 4 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCUART_D3                                                     \
    0x00000008 // UART Module 3 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCUART_D2                                                     \
    0x00000004 // UART Module 2 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCUART_D1                                                     \
    0x00000002 // UART Module 1 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCUART_D0                                                     \
    0x00000001 // UART Module 0 Deep-Sleep Mode
               // Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_DCGCSSI_D3                                                      \
    0x00000008 // SSI Module 3 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCSSI_D2                                                      \
    0x00000004 // SSI Module 2 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCSSI_D1                                                      \
    0x00000002 // SSI Module 1 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCSSI_D0                                                      \
    0x00000001 // SSI Module 0 Deep-Sleep Mode
               // Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_DCGCI2C_D3                                                      \
    0x00000008 // I2C Module 3 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCI2C_D2                                                      \
    0x00000004 // I2C Module 2 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCI2C_D1                                                      \
    0x00000002 // I2C Module 1 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCI2C_D0                                                      \
    0x00000001 // I2C Module 0 Deep-Sleep Mode
               // Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_DCGCUSB_D0                                                      \
    0x00000001 // USB Module Deep-Sleep Mode Clock
               // Gating Control
...
//
//*****************************************************************************
#define SYSCTL_DCGCCAN_D1                                                      \
    0x00000002 // CAN Module 1 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCCAN_D0                                                      \
    0x00000001 // CAN Module 0 Deep-Sleep Mode
               // Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_DCGCADC_D1                                                      \
    0x00000002 // ADC Module 1 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCADC_D0                                                      \
    0x00000001 // ADC Module 0 Deep-Sleep Mode
               // Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_DCGCPWM_D1                                                      \
    0x00000002 // PWM Module 1 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCPWM_D0                                                      \
    0x00000001 // PWM Module 0 Deep-Sleep Mode
               // Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_DCGCQEI_D1                                                      \
    0x00000002 // QEI Module 1 Deep-Sleep Mode
               // Clock Gating Control
#define SYSCTL_DCGCQEI_D0                                                      \
    0x00000001 // QEI Module 0 Deep-Sleep Mode
               // Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_DCGCEEPROM_D0                                                   \
    0x00000001 // EEPROM Module Deep-Sleep Mode
               // Clock Gating Control
...
//
//*****************************************************************************
#define SYSCTL_DCGCWTIMER_D5                                                   \
    0x00000020 // 32/64-Bit Wide General-Purpose
               // Timer 5 Deep-Sleep Mode Clock
               // Gating Control
#define SYSCTL_DCGCWTIMER_D4                                                   \
    0x00000010 // 32/64-Bit Wide General-Purpose
               // Timer 4 Deep-Sleep Mode Clock
               // Gating Control
#define SYSCTL_DCGCWTIMER_D3                                                   \
    0x00000008 // 32/64-Bit Wide General-Purpose
               // Timer 3 Deep-Sleep Mode Clock
               // Gating Control
#define SYSCTL_DCGCWTIMER_D2                                                   \
    0x00000004 // 32/64-Bit Wide General-Purpose
               // Timer 2 Deep-Sleep Mode Clock
               // Gating Control
#define SYSCTL_DCGCWTIMER_D1                                                   \
    0x00000002 // 32/64-Bit Wide General-Purpose
               // Timer 1 Deep-Sleep Mode Clock
               // Gating Control
#define SYSCTL_DCGCWTIMER_D0                                                   \
    0x00000001 // 32/64-Bit Wide General-Purpose
...
//
//*****************************************************************************
#define SYSCTL_PRWD_R1                                                         \
    0x00000002 // Watchdog Timer 1 Peripheral
               // Ready
#define SYSCTL_PRWD_R0                                                         \
    0x00000001 // Watchdog Timer 0 Peripheral
               // Ready
...
//
//*****************************************************************************
#define SYSCTL_PRTIMER_R5                                                      \
    0x00000020 // 16/32-Bit General-Purpose Timer
               // 5 Peripheral Ready
#define SYSCTL_PRTIMER_R4                                                      \
    0x00000010 // 16/32-Bit General-Purpose Timer
               // 4 Peripheral Ready
#define SYSCTL_PRTIMER_R3                                                      \
    0x00000008 // 16/32-Bit General-Purpose Timer
               // 3 Peripheral Ready
#define SYSCTL_PRTIMER_R2                                                      \
    0x00000004 // 16/32-Bit General-Purpose Timer
               // 2 Peripheral Ready
#define SYSCTL_PRTIMER_R1                                                      \
    0x00000002 // 16/32-Bit General-Purpose Timer
               // 1 Peripheral Ready
#define SYSCTL_PRTIMER_R0                                                      \
    0x00000001 // 16/32-Bit General-Purpose Timer
               // 0 Peripheral Ready
...
//
//*****************************************************************************
#define SYSCTL_PRHIB_R0                                                        \
    0x00000001 // Hibernation Module Peripheral
               // Ready
...
//
//*****************************************************************************
#define SYSCTL_PRWTIMER_R5                                                     \
    0x00000020 // 32/64-Bit Wide General-Purpose
               // Timer 5 Peripheral Ready
#define SYSCTL_PRWTIMER_R4                                                     \
    0x00000010 // 32/64-Bit Wide General-Purpose
               // Timer 4 Peripheral Ready
#define SYSCTL_PRWTIMER_R3                                                     \
    0x00000008 // 32/64-Bit Wide General-Purpose
               // Timer 3 Peripheral Ready
#define SYSCTL_PRWTIMER_R2                                                     \
    0x00000004 // 32/64-Bit Wide General-Purpose
               // Timer 2 Peripheral Ready
#define SYSCTL_PRWTIMER_R1                                                     \
    0x00000002 // 32/64-Bit Wide General-Purpose
               // Timer 1 Peripheral Ready
#define SYSCTL_PRWTIMER_R0                                                     \
    0x00000001 // 32/64-Bit Wide General-Purpose
...
#define UDMA_STAT_STATE_WAIT                                                   \
    0x00000060                             // Waiting for uDMA request to
                                           // clear
...
//
//*****************************************************************************
#define UDMA_ALTBASE_ADDR_M                                                    \
    0xFFFFFFFF // Alternate Channel Address
               // Pointer
...
#define UDMA_CHASGN_PRIMARY                                                    \
    0x00000000 // Use the primary channel
               // assignment
#define UDMA_CHASGN_SECONDARY                                                  \
    0x00000001 // Use the secondary channel
               // assignment
...
//
//*****************************************************************************
#define NVIC_ACTLR_DISOOFP                                                     \
    0x00000200                        // Disable Out-Of-Order Floating
                                      // Point
...
#define NVIC_ACTLR_DISMCYC                                                     \
    0x00000001 // Disable Interrupts of Multiple
               // Cycle Instructions
...
//
//*****************************************************************************
#define NVIC_PRI33_INTD_M                                                      \
    0xE0000000 // Interrupt Priority for Interrupt
               // [4n+3]
#define NVIC_PRI33_INTC_M                                                      \
    0x00E00000 // Interrupt Priority for Interrupt
               // [4n+2]
#define NVIC_PRI33_INTB_M                                                      \
    0x0000E000 // Interrupt Priority for Interrupt
               // [4n+1]
#define NVIC_PRI33_INTA_M                                                      \
    0x000000E0 // Interrupt Priority for Interrupt
               // [4n]
...
//
//*****************************************************************************
#define NVIC_PRI34_INTD_M                                                      \
    0xE0000000 // Interrupt Priority for Interrupt
               // [4n+3]
#define NVIC_PRI34_INTC_M                                                      \
    0x00E00000 // Interrupt Priority for Interrupt
               // [4n+2]
#define NVIC_PRI34_INTB_M                                                      \
    0x0000E000 // Interrupt Priority for Interrupt
               // [4n+1]
#define NVIC_PRI34_INTA_M                                                      \
    0x000000E0 // Interrupt Priority for Interrupt
               // [4n]
...
//
//*****************************************************************************
#define NVIC_CFG_CTRL_STKALIGN                                                 \
    0x00000200 // Stack Alignment on Exception
               // Entry
...
#define NVIC_FAULT_STAT_UNDEF                                                  \
    0x00010000                           // Undefined Instruction Usage
                                         // Fault
#define NVIC_FAULT_STAT_BFARV 0x00008000 // Bus Fault Address Register Valid
#define NVIC_FAULT_STAT_BLSPERR                                                \
    0x00002000                             // Bus Fault on Floating-Point Lazy
                                           // State Preservation
...
#define NVIC_FAULT_STAT_MMARV                                                  \
    0x00000080 // Memory Management Fault Address
               // Register Valid
#define NVIC_FAULT_STAT_MLSPERR                                                \
    0x00000020                            // Memory Management Fault on
...
#define NVIC_CPAC_CP11_M                                                       \
    0x00C00000                         // CP11 Coprocessor Access
                                       // Privilege
...
#define NVIC_CPAC_CP10_M                                                       \
    0x00300000                         // CP10 Coprocessor Access
                                       // Privilege
...
#define NVIC_DBG_CTRL_S_RESET_ST 0x02000000 // Core has reset since last read
...
#define NVIC_DBG_CTRL_C_SNAPSTALL 0x00000020 // Breaks a stalled load/store
...
#define NVIC_FPCC_ASPEN                                                        \
    0x80000000                      // Automatic State Preservation
                                    // Enable
...
#define NVIC_FPDSC_RMODE_RP                                                    \
    0x00400000 // Round towards Plus Infinity (RP)
               // mode
#define NVIC_FPDSC_RMODE_RM                                                    \
    0x00800000                         // Round towards Minus Infinity
                                       // (RM) mode
