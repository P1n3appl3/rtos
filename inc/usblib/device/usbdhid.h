...
#define COMPOSITE_DHID_SIZE                                                    \
    (HIDINTERFACE_SIZE + HIDINENDPOINT_SIZE + HIDOUTENDPOINT_SIZE +            \
     HIDDESCRIPTOR_SIZE)
...
#define UsagePageVendor(ui16Value)                                             \
    0x06, ((ui16Value)&0xFF), (((ui16Value) >> 8) & 0xFF)
...
#define UsageVendor(ui16Value)                                                 \
    0x0A, ((ui16Value)&0xFF), (((ui16Value) >> 8) & 0xFF)
...
#define PhysicalMinimum(i16Value)                                              \
    0x36, ((i16Value)&0xFF), (((i16Value) >> 8) & 0xFF)
...
#define PhysicalMaximum(i16Value)                                              \
    0x46, ((i16Value)&0xFF), (((i16Value) >> 8) & 0xFF)
...
//
//*****************************************************************************
#define Input2(ui16Value) 0x82, ((ui16Value)&0xff), (((ui16Value) >> 8) & 0xFF)
...
#define Feature2(ui16Value)                                                    \
    0xB2, ((ui16Value)&0xff), (((ui16Value) >> 8) & 0xFF)
...
//
//*****************************************************************************
#define Output2(ui16Value) 0x92, ((ui16Value)&0xff), (((ui16Value) >> 8) & 0xFF)
...
extern void* USBDHIDCompositeInit(uint32_t ui32Index, tUSBDHIDDevice* psDevice,
