...
typedef struct {
    ...
    //
    const struct tDeviceInfo* psDevInfo;
...
//
//*****************************************************************************
extern void USBDCDInit(uint32_t ui32Index, struct tDeviceInfo* psDevice,
                       void* pvDCDCBData);
...
USBDCDConfigGetInterface(const tConfigHeader* psConfig, uint32_t ui32Index,
                         uint32_t ui32AltCfg, uint32_t* pui32Section);
...
extern bool USBDCDFeatureSet(uint32_t ui32Index, uint32_t ui32Feature,
                             void* pvFeature);
extern bool USBDCDFeatureGet(uint32_t ui32Index, uint32_t ui32Feature,
                             void* pvFeature);
