...
#define DECLARE_EVENT_DRIVER(VarName, pfnOpen, pfnClose, pfnEvent)             \
    ...
    const tUSBHostClassDriver VarName = {USB_CLASS_EVENTS, 0, 0, pfnEvent}
...
extern int32_t USBHCDEventDisable(uint32_t ui32Index, void* pvEventDriver,
                                  uint32_t ui32Event);
extern void USBHCDInit(uint32_t ui32Index, void* pvData, uint32_t ui32Size);
extern void USBHCDPowerConfigInit(uint32_t ui32Index, uint32_t ui32Flags);
extern uint32_t USBHCDPowerConfigGet(uint32_t ui32Index);
extern uint32_t USBHCDPowerConfigSet(uint32_t ui32Index, uint32_t ui32Config);
...
extern uint32_t USBHCDPipeAlloc(uint32_t ui32Index, uint32_t ui32EndpointType,
...
extern uint8_t USBHCDDevSubClass(uint32_t ui32Instance, uint32_t ui32Interface);
extern uint8_t USBHCDDevProtocol(uint32_t ui32Instance, uint32_t ui32Interface);
