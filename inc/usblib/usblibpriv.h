...
struct tUSBDMAInstance {
    ...
    uint32_t (*pfnTransfer)(tUSBDMAInstance* psUSBDMAInst, uint32_t ui32Channel,
                            void* pvBuffer, uint32_t ui32Size);
    void (*pfnUnitSizeSet)(tUSBDMAInstance* psUSBDMAInst, uint32_t ui32Channel,
...
#define USBLibDMATransfer(psUSBDMAInst, ui32Channel, pvBuffer, ui32Size)       \
    psUSBDMAInst->pfnTransfer(psUSBDMAInst, ui32Channel, pvBuffer, ui32Size)
...
#define USBLibDMAChannelAllocate(psUSBDMAInst, ui8Endpoint, ui32MaxPacketSize, \
                                 ui32Config)                                   \
    psUSBDMAInst->pfnChannelAllocate(psUSBDMAInst, ui8Endpoint,                \
                                     ui32MaxPacketSize, ui32Config)
...
#define USBLibDMAArbSizeSet(psUSBDMAInst, ui32Channel, ui32ArbSize)            \
    psUSBDMAInst->pfnArbSizeSet(psUSBDMAInst, ui32Channel, ui32ArbSize);
