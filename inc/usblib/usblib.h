...
#define USB3Byte(ui32Value)                                                    \
    (ui32Value & 0xff), ((ui32Value >> 8) & 0xff), ((ui32Value >> 16) & 0xff)
...
#define NEXT_USB_DESCRIPTOR(ptr)                                               \
    (tDescriptorHeader*)(((uint8_t*)(ptr)) + *((uint8_t*)(ptr)))
...
extern tDescriptorHeader* USBDescGet(tDescriptorHeader* psDesc,
                                     ...
                                     uint32_t ui32Index);
extern uint32_t USBDescGetNumAlternateInterfaces(tConfigDescriptor* psConfig,
...
extern void USBRingBufRead(tUSBRingBufObject* psUSBRingBuf, uint8_t* pui8Data,
                           uint32_t ui32Length);
...
extern void USBRingBufAdvanceRead(tUSBRingBufObject* psUSBRingBuf,
                                  uint32_t ui32NumBytes);
extern void USBRingBufInit(tUSBRingBufObject* psUSBRingBuf, uint8_t* pui8Buf,
                           uint32_t ui32Size);
