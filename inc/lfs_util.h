...
#include <assert.h>
#endif
#if !defined(LFS_NO_DEBUG) || !defined(LFS_NO_WARN) ||                         \
    !defined(LFS_NO_ERROR) || defined(LFS_YES_TRACE)
#include "printf.h"
#endif
...
// toolchain-specific implementations. LFS_NO_INTRINSICS falls back to a
// more expensive basic C implementation for debugging purposes
