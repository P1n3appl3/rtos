...
//
//*****************************************************************************
const tConfigSection g_sHIDConfigSection = {sizeof(g_pui8MouseDescriptor),
                                            g_pui8MouseDescriptor};

const tConfigSection g_sHIDInterfaceSection = {sizeof(g_pui8HIDInterface),
                                               g_pui8HIDInterface};

const tConfigSection g_sHIDInEndpointSection = {sizeof(g_pui8HIDInEndpoint),
                                                g_pui8HIDInEndpoint};
...
tConfigSection g_sHIDDescriptorSection = {
    sizeof(g_sMouseHIDDescriptor), (const uint8_t*)&g_sMouseHIDDescriptor};
...
#define NUM_HID_SECTIONS (sizeof(g_psHIDSections) / sizeof(g_psHIDSections[0]))
...
//
//*****************************************************************************
tConfigHeader g_sHIDConfigHeader = {NUM_HID_SECTIONS, g_psHIDSections};
...
//
//*****************************************************************************
const tConfigHeader* const g_ppsHIDConfigDescriptors[] = {&g_sHIDConfigHeader};
...
static uint32_t HIDMouseRxHandler(void* pvMouseDevice, uint32_t ui32Event,
    ...
    case USB_EVENT_CONNECTED: {
        ...
        //
        psMouseDevice->pfnCallback(psMouseDevice->pvCBData, USB_EVENT_CONNECTED,
                                   0, (void*)0);
    ...
    case USB_EVENT_LPM_ERROR: {
        return (psMouseDevice->pfnCallback(psMouseDevice->pvCBData, ui32Event,
...
//
//*****************************************************************************
uint32_t USBDHIDMouseStateChange(void* pvMouseDevice, int8_t i8DeltaX,
    ...
    if (USBDHIDTxPacketAvailable((void*)psHIDDevice)) {
        ...
        ui32Count = USBDHIDReportWrite((void*)psHIDDevice, psInst->pui8Report,
                                       MOUSE_REPORT_SIZE, true);
