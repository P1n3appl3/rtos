...
//
//*****************************************************************************
uint32_t USBDescGetNum(tDescriptorHeader* psDesc, uint32_t ui32Size,
                       uint32_t ui32Type) {
...
//
//*****************************************************************************
tDescriptorHeader* USBDescGet(tDescriptorHeader* psDesc, uint32_t ui32Size,
...
tInterfaceDescriptor* USBDescGetInterface(tConfigDescriptor* psConfig,
    ...
    if (ui32Alt == USB_DESC_ANY) {
        ...
        return ((tInterfaceDescriptor*)USBDescGet(
            (tDescriptorHeader*)psConfig, (uint32_t)psConfig->wTotalLength,
...
USBDescGetInterfaceEndpoint(tInterfaceDescriptor* psInterface,
    ...
    if (ui32Index >= psInterface->bNumEndpoints) {
        ...
        return ((tEndpointDescriptor*)USBDescGet(
            (tDescriptorHeader*)psInterface, ui32Size, USB_DTYPE_ENDPOINT,
            ui32Index));
    }
}
