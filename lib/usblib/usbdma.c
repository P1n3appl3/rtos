...
//
//*****************************************************************************
static uint32_t uDMAUSBChannelStatus(tUSBDMAInstance* psUSBDMAInst,
...
//
//*****************************************************************************
static uint32_t iDMAUSBChannelStatus(tUSBDMAInstance* psUSBDMAInst,
                                     uint32_t ui32Channel) {
    uint32_t ui32Status;
...
//
//*****************************************************************************
static void DMAUSBIntStatusClear(tUSBDMAInstance* psUSBDMAInst,
                                 uint32_t ui32Status) {
    //
...
//
//*****************************************************************************
static void DMAUSBIntHandler(tUSBDMAInstance* psUSBDMAInst,
...
//
//*****************************************************************************
static void uDMAUSBChannelEnable(tUSBDMAInstance* psUSBDMAInst,
                                 uint32_t ui32Channel) {
    ...
    //
    ui32IntEnabled = ROM_IntIsEnabled(psUSBDMAInst->ui32IntNum);
...
//
//*****************************************************************************
static void iDMAUSBChannelEnable(tUSBDMAInstance* psUSBDMAInst,
                                 uint32_t ui32Channel) {
    uint32_t ui32IntEnabled;
...
//
//*****************************************************************************
static void uDMAUSBChannelDisable(tUSBDMAInstance* psUSBDMAInst,
                                  uint32_t ui32Channel) {
    //
...
//
//*****************************************************************************
static void iDMAUSBChannelDisable(tUSBDMAInstance* psUSBDMAInst,
                                  uint32_t ui32Channel) {
    //
...
//
//*****************************************************************************
static void uDMAUSBChannelIntEnable(tUSBDMAInstance* psUSBDMAInst,
                                    uint32_t ui32Channel) {
    //
...
//
//*****************************************************************************
static void iDMAUSBChannelIntEnable(tUSBDMAInstance* psUSBDMAInst,
                                    uint32_t ui32Channel) {
    //
    // Enable the interrupt for this DMA channel.
    //
...
//
//*****************************************************************************
static void uDMAUSBChannelIntDisable(tUSBDMAInstance* psUSBDMAInst,
                                     uint32_t ui32Channel) {
    //
...
//
//*****************************************************************************
static void iDMAUSBChannelIntDisable(tUSBDMAInstance* psUSBDMAInst,
                                     uint32_t ui32Channel) {
    //
    // Disable the interrupt for this DMA channel.
    //
...
//
//*****************************************************************************
static uint32_t uDMAUSBTransfer(tUSBDMAInstance* psUSBDMAInst,
    ...
    if (ui32Size > psUSBDMAInst->pui32MaxPacketSize[ui32Channel - 1]) {
        ...
        //
        ui32PacketCount =
            ((ui32Size / psUSBDMAInst->pui32MaxPacketSize[ui32Channel - 1]));
...
//
//*****************************************************************************
static uint32_t iDMAUSBTransfer(tUSBDMAInstance* psUSBDMAInst,
                                uint32_t ui32Channel, void* pvBuffer,
                                uint32_t ui32Size) {
    uint32_t ui32PacketCount;
    ...
    if (ui32Size > psUSBDMAInst->pui32MaxPacketSize[ui32Channel - 1]) {
        ...
        if (psUSBDMAInst->pui32Config[ui32Channel - 1] & USB_DMA_CFG_DIR_TX) {
            ...
            MAP_USBEndpointDMAEnable(
                ...
                psUSBDMAInst->pui8Endpoint[ui32Channel - 1], USB_EP_HOST_OUT);
        } else {
            //
            // Make sure that DMA is enabled on the endpoint.
            //
            MAP_USBEndpointDMAEnable(
                psUSBDMAInst->ui32Base,
                psUSBDMAInst->pui8Endpoint[ui32Channel - 1], USB_EP_HOST_IN);
        }
            ...
            if (ui32Config & USB_DMA_EP_RX) {
                ...
                if (((ui32Config & USB_DMA_EP_HOST) == 0) &&
                    ...
                    psUSBDMAInst->pui32EPDMAMode0[ui32Channel] =
                        USB_EP_DMA_MODE_0 | USB_EP_AUTO_REQUEST |
                        USB_EP_HOST_IN;
                } else {
                    psUSBDMAInst->pui32EPDMAMode0[ui32Channel] =
                        USB_EP_DMA_MODE_0 | USB_EP_AUTO_CLEAR | USB_EP_HOST_IN;
                }
                ...
                if (((ui32Config & USB_DMA_EP_HOST) == 0) &&
                    ...
                    psUSBDMAInst->pui32EPDMAMode1[ui32Channel] =
                        USB_EP_DMA_MODE_1 | USB_EP_HOST_IN |
                ...
                psUSBDMAInst->pui32EPDMAMode0[ui32Channel] =
                    USB_EP_DMA_MODE_0 | USB_EP_HOST_OUT;
                psUSBDMAInst->pui32EPDMAMode1[ui32Channel] =
                    USB_EP_DMA_MODE_1 | USB_EP_HOST_OUT | USB_EP_AUTO_SET;
            }
...
static uint32_t iDMAUSBChannelAllocate(tUSBDMAInstance* psUSBDMAInst,
    ...
    for (ui32Channel = 0; ui32Channel < USB_MAX_DMA_CHANNELS_0; ui32Channel++) {
        ...
        if (psUSBDMAInst->pui8Endpoint[ui32Channel] == 0) {
            ...
            if (ui32Config & USB_DMA_EP_RX) {
                psUSBDMAInst->pui32Config[ui32Channel] =
                    USB_DMA_CFG_DIR_RX | USB_DMA_CFG_BURST_NONE |
                    USB_DMA_CFG_INT_EN;
                ...
                psUSBDMAInst->pui32Config[ui32Channel] =
                    USB_DMA_CFG_DIR_TX | USB_DMA_CFG_BURST_NONE |
                    USB_DMA_CFG_INT_EN;
...
//
//*****************************************************************************
static void uDMAUSBChannelRelease(tUSBDMAInstance* psUSBDMAInst,
                                  uint8_t ui32Channel) {
...
//
//*****************************************************************************
static void iDMAUSBChannelRelease(tUSBDMAInstance* psUSBDMAInst,
                                  uint8_t ui32Channel) {
...
//
//*****************************************************************************
static void uDMAUSBUnitSizeSet(tUSBDMAInstance* psUSBDMAInst,
                               uint32_t ui32Channel, uint32_t ui32BitSize) {
    uint32_t ui32Value;
...
//
//*****************************************************************************
static void iDMAUSBUnitSizeSet(tUSBDMAInstance* psUSBDMAInst,
                               uint32_t ui32Channel, uint32_t ui32BitSize) {}
...
//
//*****************************************************************************
static void uDMAUSBArbSizeSet(tUSBDMAInstance* psUSBDMAInst,
                              uint32_t ui32Channel, uint32_t ui32ArbSize) {
    uint32_t ui32Value;
...
//
//*****************************************************************************
static void iDMAUSBArbSizeSet(tUSBDMAInstance* psUSBDMAInst,
                              uint32_t ui32Channel, uint32_t ui32ArbSize) {}
...
tUSBDMAInstance* USBLibDMAInit(uint32_t ui32Index) {
    ...
    //
    if (USBControllerVersion(g_psUSBDMAInst[0].ui32Base) ==
