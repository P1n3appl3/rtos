...
// Lab2 Part 2: Testmain3, Testmain4, TestmainCS and realmain
...
// J6/A2/PE2 analog channel 1  <- connect an IR distance sensor to J5 to get a realistic analog signal on PE2
...
// Analog inputs
// PE3 Ain0 sampled at 10Hz, sequencer 3, by DAS software start in ISR
...
int TestmainCS(void){       // TestmainCS
  ...
  OS_Init();           // initialize, disable interrupts
  NumCreated = 0 ;
  NumCreated += OS_AddThread(&ThreadCS,128,2); 
